...
# 32-bit sage generate_params_poseidon.sage 1 0 32 3 3 64 0xfffffffb
...
FILE = "tmp.txt"
if write_file == True:
    FILE = open("poseidon_parameters.txt",'w')
...
def print_linear_layer(M, n, t):
    ...
    if write_file == True:
        ...
        FILE.write("Result Algorithm 1:" + str(algorithm_1(M, NUM_CELLS)) + "\n")
        FILE.write("Result Algorithm 2:" + str(algorithm_2(M, NUM_CELLS)) + "\n")
        FILE.write("Result Algorithm 3:" + str(algorithm_3(M, NUM_CELLS)) + "\n")
    ...
    print("MDS matrix:\n", matrix_string)
    if write_file == True:
        FILE.write("MDS matrix:" + str(matrix_string))
